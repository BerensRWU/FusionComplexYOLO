...
def parse_train_configs():
    ...
    if configs.dist_prop_lidar == 0. and configs.dist_prop_radar == 0.:
        dist_str = f'trained_disturbances_none/'
    elif configs.dist_prop_lidar == 0. and configs.dist_prop_radar != 0.:
        dist_str = f'trained_disturbances_radar/prob_{configs.dist_prop_radar}/'
    elif configs.dist_prop_lidar != 0. and configs.dist_prop_radar == 0.:
        dist_str = f'trained_disturbances_lidar/prob_{configs.dist_prop_lidar}/'
    elif configs.dist_prop_lidar != 0. and configs.dist_prop_radar != 0.:
        dist_str = f'trained_disturbances_both/prob_{configs.dist_prop_lidar}/'
    else:
